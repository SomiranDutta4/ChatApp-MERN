...
const Chatpage = () => {
  const {isSending,AccountPage,User,clickedChat,setClicked,
    LoadedChats,setLoadedChats,setChats,}=useContext(AppContext)
  ...
  if(windowWidth<=850){
    return (
      <div className='ChatPage'>
        ...
        {isAddingGroup===false && isSingleChat===false && AccountPage===false && <AllChats setAddingGroup={setAddingGroup}setSingleChat={setSingleChat} setloadAll={setloadAll}/>}
